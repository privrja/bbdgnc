...
<div id="div-right">
    ...
    <div class="form" id="form-main">
        ...
        <button type="button" id="btn-canvas-update" class="btn-same" onclick="window.location.href='<?= ServerEnum::getLink($sequence[SequenceTO::DATABASE], $sequence[SequenceTO::IDENTIFIER]) ?>'">Reference</button>
