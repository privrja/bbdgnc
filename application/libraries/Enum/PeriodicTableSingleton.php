...
class PeriodicTableSingleton {
    ...
    public function __construct() {
        $this->arAtoms = array(
            ...
            'b' => new Element('B', 5, 3, 11.009306, true),
            ...
            'o' => new Element('O', 8, 2, 15.9949146221, true),
            'F' => new Element('F', 9, 1, 18.998404),
            'f' => new Element('F', 9, 1, 18.998404, true),
            ...
            'p' => new Element('P', 15, 3, 30.97376151, true),
            'S' => new Element('S', 16, 2, 31.97207069),
            's' => new Element('S', 16, 2, 31.97207069, true),
            ...
            'i' => new Element('I', 53, 1, 126.904457, true),
